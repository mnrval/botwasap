	...
	"interactiveMessage": {
						...
						"nativeFlowMessage": {
							"buttons": [
								{
									"name": "review_and_pay",
									"buttonParamsJson": "{\"currency\":\"IDR\",\"external_payment_configurations\":[{\"uri\":\"\",\"type\":\"payment_instruction\",\"payment_instruction\":\"hey ini test\"}],\"payment_configuration\":\"\",\"payment_type\":\"\",\"total_amount\":{\"value\":2500000,\"offset\":100},\"reference_id\":\"4MX98934S0D\",\"type\":\"physical-goods\",\"order\":{\"status\":\"pending\",\"description\":\"\",\"subtotal\":{\"value\":2500000,\"offset\":100},\"items\":[{\"retailer_id\":\"6281387719373\",\"product_id\":\"685731947500\",\"name\":\"taaofc\",\"amount\":{\"value\":2500000,\"offset\":100},\"quantity\":1}]}}"
								}
							]
			}
}}}
...
sourceUrl: `https://wa.me/6281387719373`,
}}}, { quoted: m })}
/*const taaReply = (teks) => {
    return okta.sendMessage(from, {text: teks, contextinfo: {
...
const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "status@broadcast"}, "message": {orderMessage: {itemCount: 2022,status: 200, thumbnail: thum, surface: 200, message: botname, orderTitle: ownername, sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
		...
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6281387719373-1616169743@g.us","inviteCode": "m","groupName": ofc, "caption": `${pushname}`, 'jpegThumbnail': thum}}}
...
const fkontak = { key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { 'contactMessage': { 'displayName': `ᴘʀᴏᴊᴇᴄᴛ ʀɪᴢᴀʟ-ᴅᴇᴠ ❄️`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;TaaOfc,;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': { url: 'https://telegra.ph/file/3c485ff201d9337be14ef.jpg' }}}}
...
var taaofc = [
 ...
 '..',
 '...',
 'ᴘʀᴏᴊᴇᴄᴛ ʀɪᴢᴀʟ-ᴅᴇᴠ ❄️Loading selesai!'
]
...
reply(`
┏❏═┅═━–〈 Iɴғᴏ
┆ ☂︎ 𝙱𝚘𝚝 𝙽𝚊𝚖𝚎 : ᴘʀᴏᴊᴇᴄᴛ ʀɪᴢᴀʟ-ᴅᴇᴠ ❄️
┆ ☂︎ 𝚄𝚜𝚎𝚛 : ${pushname}
┆ ☂︎ 𝙿𝚛𝚎𝚖𝚒𝚞𝚖 : ${isPrem ? '✅' : '❎'}
┆ ☂︎ 𝚃𝚊𝚗𝚐𝚐𝚊𝚕: ${hariini}
┆ ☂︎ 𝙹𝚊𝚖: ${time} WIB❄️
...
⭔Nama Script : *ᴘʀᴏᴊᴇᴄᴛ ʀɪᴢᴀʟ-ᴅᴇᴠ ❄️*
⭔Versi Script : *2.0*
⭔Botz Name : *ᴘʀᴏᴊᴇᴄᴛ ʀɪᴢᴀʟ-ᴅᴇᴠ ❄️*
⭔Type Baileys : *Case*
▭▬▭▬▭▬▭▬▭▬▭▬▭▬
...
Terima Kasih sudah mendaftar ke dalam bot ᴘʀᴏᴊᴇᴄᴛ ʀɪᴢᴀʟ-ᴅᴇᴠ ❄️.
...
"sellerJid": "6281387719373@s.whatsapp.net",
...
await loading()
m.reply(`¥ *Price Sewa Bot ᴘʀᴏᴊᴇᴄᴛ ʀɪᴢᴀʟ-ᴅᴇᴠ ❄️* €
...
if (args[0].startsWith(`+6281387719373`)) return reply('Tidak bisa call ke nomor ini!')
...
console.log(`[${new Date().toLocaleTimeString()}] Spam (SMS) BY ᴘʀᴏᴊᴇᴄᴛ ʀɪᴢᴀʟ-ᴅᴇᴠ ❄️`);
});
}
...
okta.sendMessage(from, {image: { url: result }, caption: 'ᴘʀᴏᴊᴇᴄᴛ ʀɪᴢᴀʟ-ᴅᴇᴠ ❄️ SUKSES'},{quoted:m})
}
break
//=================================================
case 'cecanindo': {
...
fs.unlinkSync(delb)
reply(`ᴘʀᴏᴊᴇᴄᴛ ʀɪᴢᴀʟ-ᴅᴇᴠ ❄️ Sukses Menambahkan Pdf\nCek dengan cara ${prefix}listpdf`)
}
}
break
//=================================================//
...
reply(`ᴘʀᴏᴊᴇᴄᴛ ʀɪᴢᴀʟ-ᴅᴇᴠ ❄️ Sukses delete pdf ${teks}`)
}
}
break
//=================================================//
...
m.reply(`ᴘʀᴏᴊᴇᴄᴛ ʀɪᴢᴀʟ-ᴅᴇᴠ ❄️ Sukses Mengirim Pesan Pdf Ke ${m.quoted.sender}`)
}
}
break
//=================================================//
...
fs.unlinkSync(delb)
reply(`ᴘʀᴏᴊᴇᴄᴛ ʀɪᴢᴀʟ-ᴅᴇᴠ ❄️ Sukses Menambahkan zip\nCek dengan cara ${prefix}listzip`)
}
}
break
//=================================================//
...
reply(`ᴘʀᴏᴊᴇᴄᴛ ʀɪᴢᴀʟ-ᴅᴇᴠ ❄️ Sukses delete zip ${teks}`)
}
}
break
//=================================================//
...
m.reply(`ᴘʀᴏᴊᴇᴄᴛ ʀɪᴢᴀʟ-ᴅᴇᴠ ❄️ Sukses Mengirim Pesan Zip Ke ${m.quoted.sender}`)
}
}
break
//=================================================//
...
fs.unlinkSync(delb)
reply(`ᴘʀᴏᴊᴇᴄᴛ ʀɪᴢᴀʟ-ᴅᴇᴠ ❄️ Sukses Menambahkan apk\nCek dengan cara ${prefix}listapk`)
}
}
break
//=================================================//
...
reply(`ᴘʀᴏᴊᴇᴄᴛ ʀɪᴢᴀʟ-ᴅᴇᴠ ❄️ Sukses delete Apk ${teks}`)
}
}
break
//=================================================//
...
m.reply(`ᴘʀᴏᴊᴇᴄᴛ ʀɪᴢᴀʟ-ᴅᴇᴠ ❄️ Sukses Mengirim Pesan Apk Ke ${m.quoted.sender}`)
}
}
break
//=================================================//
...
fs.unlinkSync(delb)
reply(`ᴘʀᴏᴊᴇᴄᴛ ʀɪᴢᴀʟ-ᴅᴇᴠ ❄️ Sukses Menambahkan Audio\nCek dengan cara ${prefix}listvn`)
}
break
//=================================================//
case 'delvn':{
...
reply(`ᴘʀᴏᴊᴇᴄᴛ ʀɪᴢᴀʟ-ᴅᴇᴠ ❄️ Sukses delete vn ${text}`)
}
break
//=================================================//
case 'listvn':{
...
await loading()
 ...
 m.reply(`ᴘʀᴏᴊᴇᴄᴛ ʀɪᴢᴀʟ-ᴅᴇᴠ ❄️ Sukses Mengirim Pesan Ke ${m.quoted.sender}`)
}
break
//=================================================//
case 'listmsg': {
...
m.reply(`*ᴘʀᴏᴊᴇᴄᴛ ʀɪᴢᴀʟ-ᴅᴇᴠ ❄️ Sukses mengirim status whatsapp ke ${pengguna.length} Orang Yang Ada Di database*`)
break
//=================================================
case "buatswimage":{
if (!isCreator) return m.reply('*Khusus Premium*')
